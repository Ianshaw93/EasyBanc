...
class PageThree(tk.Frame):
    ...
    def trainmodel(self):
        ...
        messagebox.showinfo("SUCCESS", "Welcome to the Easy Bank Network!")
        self.controller.show_frame("PageFour")
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Login", command=self.openwebcam, fg="#ffffff", bg="#263942")
    ...
    def openwebcam(self):
        ...
        time.sleep(10)
        messagebox.showinfo("Welcome back " + active_name + "!")
        #self.login
...
#         self.controller = controller
#
#         label = tk.Label(self, text="Your Account", font='Helvetica 16 bold')
#         label.grid(row=0,column=0, sticky="ew")
#         button1 = tk.Button(self, text="Home", fg="#ffffff", bg="#263942")
